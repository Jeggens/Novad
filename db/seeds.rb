...
"],
["Tom Hanks", 60, "United States", "Thomas Jeffrey Hanks[2] (born July 9, 1956)[3][4] is an American actor and filmmaker. He is known for his various comedic and dramatic film roles, including Splash (1984), Big (1988), Turner & Hooch (1989), A League of Their Own (1992), Sleepless in Seattle (1993), Philadelphia (1993), Forrest Gump (1994), Apollo 13 (1995), Saving Private Ryan (1998), The Green Mile (1999), Cast Away (2000), Catch Me if You Can (2002), and The Da Vinci Code (2006), as well as for his voice work in the animated films The Polar Express (2004) and the Toy Story series.
Hanks' films have grossed more than $4.5 billion at U.S. and Canadian box offices and more than $9.0 billion worldwide,[5] making him the third highest-grossing actor in North America.[6] Hanks has been nominated for numerous awards during his career. He won a Golden Globe Award and an Academy Award for Best Actor for his role in Philadelphia, as well as a Golden Globe, an Academy Award, a Screen Actors Guild Award, and a People's Choice Award for Best Actor for his role in Forrest Gump. In 2004, he received the Stanley Kubrick Britannia Award for Excellence in Film from the British Academy of Film and Television Arts (BAFTA).[7] In 2014, he received a Kennedy Center Honor and, in 2016, he received a Presidential Medal of Freedom from President Barack Obama,[8] as well as the French Legion of Honor.
...
actor_movies["Elijah Wood"] = [
  ...
  ["The good son",
  1993,
  "https://upload.wikimedia.org/wikipedia/en/thumb/0/07/The_Good_Son_%28movie_poster%29.jpg/220px-The_Good_Son_%28movie_poster%29.jpg",
  ...
  "Drama, Family, Thriller, Crime"
  ]
]

actor_movies["Orlando Bloom"] = [
  ["Pirates of the Caribbean - The curse of the black pearl",
  2003,
  "https://upload.wikimedia.org/wikipedia/en/0/0e/Pirates_of_the_Caribbean_movie.jpg",
  "In the late 18th century, while sailing to Port Royal, Jamaica, Governor Weatherby Swann, his daughter Elizabeth, and Lieutenant James Norrington encounter a shipwreck and recover a boy, Will Turner. Elizabeth discovers a golden pirate medallion around his neck, keeping it in order to protect him. Elizabeth sees a ghost ship vanish into the fog.
...
actor_movies.each do | actor_name, movies |
   actor = Actor.find_by( name: actor_name )

   movies.each do | title, year, cover, plot, genres |
      movie = Movie.create( title:title, actor_id: actor.id, year: year, cover: cover, plot: plot )
      ...
      genres.split( ", ").each do |genre_name|
         ...
         GenresMovies.create( movie: movie, genre: genre )
      end
   end
end
